...
public class GradeController {
 ...
 @RequestMapping("/room/grade/list")
  public String list(@RequestParam("no") int classNo, Model model) throws Exception{
   ...
   for (ClazzMember cm : clazzMembers) {
     userAssignmentSubmits.put(cm.getUserNo(), assignmentSubmitService.list(classNo, cm.getUserNo()));
   }
