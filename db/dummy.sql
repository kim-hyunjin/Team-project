...
insert into assignment(class_no, member_no, title, content, file, deadline, standard)
  values(5, 13, '자반콩 만들기', '잘해오세요', '요리법.pdf', '2020-02-21 23:50:14', '얼마나 맛있게 했나 평가');
insert into assignment(class_no, member_no, title, content, file, deadline, standard)
  values(5, 13, '오징어채 만들기', '맛있게 만들기', '요리방법.txt', '2020-03-31 23:50:14', '얼마나 맛있게 했나 평가');
insert into assignment(class_no, member_no, title, content, file, deadline, standard)
  values(5, 14, '김치찌개 만들기', '돼지고기, 참치 등 자유롭게 만들기', '방법.txt', '2020-04-02 23:50:14', '얼마나 맛있게 했나 평가');
insert into assignment(class_no, member_no, title, deadline)
  values(5, 14, '만둣국 만들기', '2020-04-01 23:50:14');
insert into assignment(class_no, member_no, title, deadline)
  values(5, 14, '오믈렛 만들기', '2020-04-01 23:50:14');
  
-- 과제 제출 입력

insert into assignment_submmit(member_no, assignment_no, file, score, content, feedback)
  values(11, 17, 'b.pdf', 30, '열심히해왔습니다.', '잘못해왔습니다.');
insert into assignment_submmit(member_no, assignment_no, file, score, content, feedback)
  values(12, 18, 'c.pdf', 40, '열심히해왔습니다.', '잘못해왔습니다.');
insert into assignment_submmit(member_no, assignment_no, file, score, content, feedback)
  values(12, 19, 'f.pdf', 100, '열심히해왔습니다.', 'very good');
insert into assignment_submmit(member_no, assignment_no, file, score, content, feedback)
  values(11, 20, 'g.pdf', 90, '열심히해왔습니다.', '잘했어요~!.');
insert into assignment_submmit(member_no, assignment_no, file, score, content, feedback)
  values(15, 21, 'g.pdf', 90, '열심히해왔습니다.', '마스터피스입니다');
  
-- 질문 입력

insert into question(member_no, title, content, file, deadLine)
  values(13, '단답형-수업어떤가요?', '자유롭게 의견 보내주세요', '참고.txt', '2020-04-01 20:49:32');
insert into question(member_no, title, content, file, deadLine)
  values(13, '[단답]-만들고 싶은 음식은?', '수업 중 만들고 싶은 음식들 알려주세요', '요리종류예시.pdf', '2020-04-01 20:49:32');
insert into question(member_no, title, content, deadLine)
  values(13, '원하는 수업시간은?', '다섯가지 선택지중 골라주세요', '2020-04-01 20:49:32');
insert into question(member_no, title, content, file, deadLine)
  values(14, '수업 만족도 조사', '자유롭게 선택해주세요', '수업 내용.pdf', '2020-04-01 20:49:32');
insert into question(member_no, title, content, deadLine)
  values(14, '내일 무얼 만들까요?', '골라주세요', '2020-04-01 20:49:32');
...
insert into message(caller_no, receiver_no, content)
 values(1, 3, '수업 너무 유익해용');
insert into message(caller_no, receiver_no, content)
 values(3, 4, '수업 잘 되가나요?');
insert into message(caller_no, receiver_no, content)
 values(1, 5, '집가고싶다');
insert into message(caller_no, receiver_no, content)
 values(2, 5, '술먹고싶다');
...
insert into post(board_no, member_no, title, content)
    values(3, 11, '선생님 질문있습니다!', '찌개 끓일때 어떤 간장 써야 하나요?');
insert into post(board_no, member_no, title, content)
    values(2, 13, '수업자료 받아가세요~!', '음식입니다.');
insert into post(board_no, member_no, title, content)
    values(3, 13, '코딩잘하는방법은?', '없습니다..');
insert into post(board_no, member_no, title, content)
    values(1, 14, '공지사항입니다.', '내일 수업 쉽니다.');
insert into post(board_no, member_no, title, content)
    values(5, 12, '여러분 이거 어때요?', '우리 내일 다같이 회식ㄱ?');
insert into post(board_no, member_no, title, content)
    values(4, 15, '1조 홧팅', '다같이 힘내봐요');
  
 
-- 클래스 태그 입력
insert into class_tag(class_no, tag_no) values(5, 1);
insert into class_tag(class_no, tag_no) values(5, 2);
insert into class_tag(class_no, tag_no) values(5, 3);
insert into class_tag(class_no, tag_no) values(5, 4);
insert into class_tag(class_no, tag_no) values(5, 5);
...
-- 과제 태그 입력
insert into assignment_tag(assignment_no, tag_no) values (17, 1);
insert into assignment_tag(assignment_no, tag_no) values (18, 2);
insert into assignment_tag(assignment_no, tag_no) values (19, 3);
insert into assignment_tag(assignment_no, tag_no) values (20, 4);
insert into assignment_tag(assignment_no, tag_no) values (21, 5);
