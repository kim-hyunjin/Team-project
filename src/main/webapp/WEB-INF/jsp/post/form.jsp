...
<body>
  <div class="container">
  <h3>게시글 등록</h3>
  <form class="mt-5" action='../post/add' method='post' enctype='multipart/form-data' onsubmit='return formCheck(this)'>
    <input name="boardNo" type="hidden" value="${boardNo}">
    <div class="inputGroup mb-3" style="width:58em;">
      <div>
        <label class="inputGroupText">제목</label> <input id='titleInput' name='title' type='text'
